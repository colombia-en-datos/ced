    ...
    <section className="flex flex-col gap-4">
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Selecciona qué eventos de política pública mostrar como marcadores
            en las gráficas anuales. El número corresponde al marcador en las
            gráficas.
          </p>
        </div>
      </div>
      <div className="grid gap-3 pl-7 sm:grid-cols-2">
        {EVENT_GROUPS.map((group) => {
          const groupChecked = group.events.every((e) =>
            enabledEvents.has(e.label)
          )
          return (
    ...
    <section className="flex flex-col gap-4">
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Define el rango de años visible en las gráficas. Mínimo {MIN_WINDOW}{' '}
            años.
          </p>
        </div>
      </div>
  ...
  return (
    <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
      <div className="px-4 lg:px-6">
        ...
        <p className="text-sm text-muted-foreground">
          Personaliza cómo se muestran los datos en las gráficas. Los cambios se
          aplican inmediatamente a todos los indicadores.
        </p>
      </div>
